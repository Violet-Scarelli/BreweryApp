...
namespace BreweryRestAPI.Controllers
{
    ...
    {
        private readonly BreweryAppContext _context;

        public IngredientsController(BreweryAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Ingredient>> PostIngredient(Ingredient ingredient)
        {
          if (_context.Ingredients == null)
          {
              return Problem("Entity set 'BreweryAppContext.Ingredients'  is null.");
          }
